...
namespace Opm {
    ...
    public:
        ...
        bool supportsKeyword(const fst::string& keyword) const;
        bool hasKeyword(const fst::string& keyword) const;
        size_t size() const;
        const GridProperty<T>& getKeyword(const fst::string& keyword) const;
        const GridProperty<T>& getInitializedKeyword(const fst::string& keyword) const;


        bool addKeyword(const fst::string& keywordName);
        void copyKeyword(const fst::string& srcField ,
        ...
        GridProperty<T>& getOrCreateProperty(const fst::string& name);
        ...
        */
        ...
        typedef typename std::map< fst::string , GridProperty<T> > storage;
    ...
    private:
        ...
        void postAddKeyword(const fst::string& name,
                            const T defaultValue,
                            std::function< void( std::vector< T >& ) > postProcessor,
                            const std::string& dimString );
        GridProperty<T>& getKeyword(const fst::string& keyword);
        bool addAutoGeneratedKeyword_(const fst::string& keywordName) const;
        void insertKeyword(const SupportedKeywordInfo& supportedKeyword) const;
        bool isAutoGenerated_(const fst::string& keyword) const;
        ...
        std::unordered_map< fst::string, SupportedKeywordInfo> m_supportedKeywords;

        mutable storage m_properties;
        mutable std::set< fst::string > m_autoGeneratedProperties;
    };
